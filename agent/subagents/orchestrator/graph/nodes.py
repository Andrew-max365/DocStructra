...
def ingest_node(state: GraphState) -> dict:
    from agent.subagents.ingest_parse.api import parse_docx_to_blocks
...
def reason_node(state: GraphState) -> dict:
    ...
    from agent.subagents.validate_review.api import LLMClient
    from agent.subagents.format_act.api import SmartJudge
    from agent.subagents.ingest_parse.api import iter_all_paragraphs
    import traceback
...
def reflect_node(state: GraphState) -> dict:
    ...
    from agent.subagents.validate_review.api import LLMClient
    from agent.subagents.format_act.api import load_spec
    from agent.subagents.validate_review.api import summarize_spec
    from config import REFLECTION_MAX_ITERS
    from agent.subagents.validate_review.api import docx_to_pdf, pdf_to_images
